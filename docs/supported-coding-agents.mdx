...
<Card title="pi" icon="https://pi.dev/logo-auto.svg" href="/agents/pi">
pi coding agent, via the pi-acp adapter (Vibe Kanban pins its own fork of that adapter, which is what makes the
model and thinking-level picker work)
</Card>
</CardGroup>

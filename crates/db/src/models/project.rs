...
impl Project {
    ...
    pub async fn create(pool: &SqlitePool, data: &CreateProject) -> Result<Self, sqlx::Error> {
        ...
        sqlx::query_as!(
            ...
            r#"INSERT INTO projects (id, name)
               VALUES ($1, $2)
               RETURNING id as "id!: Uuid", name, default_agent_working_dir, remote_project_id as "remote_project_id: Uuid", created_at as "created_at!: DateTime<Utc>", updated_at as "updated_at!: DateTime<Utc>""#,
            id,
            data.name
        )
        .fetch_one(pool)
    ...
    pub async fn delete(pool: &SqlitePool, id: Uuid) -> Result<u64, sqlx::Error> {
        // Tasks cascade via FOREIGN KEY ... ON DELETE CASCADE.
